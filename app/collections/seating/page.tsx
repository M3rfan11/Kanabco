...
const seatingProducts: Product[] = [
  ...
  {
    id: "embrace-lounge-chair",
    name: "Embrace Lounge Chair",
    price: 85000.0,
    image: "/placeholder.svg?height=400&width=300&text=Embrace+Lounge+Chair",
    colors: ["Beige", "Navy", "Charcoal"],
  },
  {
    id: "scandinavian-dining-chair",
    name: "Scandinavian Dining Chair",
    price: 3500.0,
    image: "/placeholder.svg?height=400&width=300&text=Scandinavian+Dining+Chair",
  ...
  },
  {
    ...
    discount: 14,
    image: "/placeholder.svg?height=400&width=300&text=Executive+Office+Chair",
  ...
  },
  {
    ...
    price: 7500.0,
    image: "/placeholder.svg?height=400&width=300&text=Vintage+Armchair",
      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div className="flex items-center gap-4">
            ...
            <span className="text-gray-600 font-gill-sans">{seatingProducts.length} products</span>
          </div>
